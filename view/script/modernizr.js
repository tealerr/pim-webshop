...
;(window.Modernizr = (function (a, b, c) {
            ...
            e &&
              ...
              /^range$/.test(g) && j.style.WebkitAppearance !== c
                ? (f.appendChild(j),
                  ...
                  (e =
                    h.getComputedStyle &&
                    h.getComputedStyle(j, null).WebkitAppearance !== 'textfield' &&
                    j.offsetHeight !== 0),
                  f.removeChild(j))
                : /^(search|tel)$/.test(g) ||
                  (/^(url|email)$/.test(g) ? (e = j.checkValidity && j.checkValidity() === !1) : (e = j.value != k))),
            (r[a[d]] = !!e)
        return r
  ...
  var d = '2.7.1',
    ...
    x = function (b) {
      ...
      var d
      return (
        w('@media ' + b + ' { #' + g + ' { position: absolute; } }', function (b) {
  ...
  !C(y, 'undefined') && !C(y.call, 'undefined')
    ...
    (q.generatedcontent = function () {
      ...
      return (
        w(
          ['#', g, '{font:0/0 a}#', g, ':after{content:"', k, '";visibility:hidden;font:3px/1 a}'].join(''),
          function (b) {
            a = b.offsetHeight >= 3
          },
        ),
