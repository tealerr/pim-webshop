    ...
    c.widget("ui.tabs", {
        ...
        _tabify: function (q) {
            ...
            if (q) {
                ...
                f.selected =
                    (f.selected >= 0 && this.anchors[f.selected]) ||
                    f.selected < 0
                        ? f.selected
                        : 0
                f.disabled = c
            ...
            for (var j = 0, p; (p = this.lis[j]); j++) {
                c(p)[
                    c.inArray(j, f.disabled) != -1 &&
                    !c(p).hasClass("ui-tabs-selected")
                        ? "addClass"
                        : "removeClass"
                ]("ui-state-disabled")
            }
        ...
        add: function (g, f, e) {
            ...
            var d = this,
                ...
                j = !g.indexOf("#")
                    ? g.replace("#", "")
                    : this._tabId(c("a", k)[0])
            k.addClass("ui-state-default ui-corner-top").data(
                "destroy.tabs",
                true
            )
            var h = c("#" + j)
